...
const fragmentShader = await fetch('demos/00-hello-world/fragment-shader.glsl', noCache).then(response => response.text());
const vertexShader = await fetch('demos/00-hello-world/vertex-shader.glsl', noCache).then(response => response.text());
...
const texture = loadTexture('images/bayer.png');
